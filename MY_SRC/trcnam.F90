...
902   IF( ios >  0 )   CALL ctl_nam ( ios , 'namtrc in configuration namelist' )
   ...
   SUBROUTINE trc_nam_trc
      ...
      !!
      NAMELIST/namtrc/jp_bgc, ln_pisces, ln_bling, ln_my_trc, ln_age, ln_cfc11, ln_cfc12, ln_sf6, ln_c14, &
...
902   IF( ios >  0 )   CALL ctl_nam ( ios , 'namtrc in configuration namelist' )
      ...
      IF( .NOT. ln_pisces .AND. .NOT. ln_my_trc .AND. .NOT. ln_bling)   jp_bgc = 0
      ll_cfc = ln_cfc11 .OR. ln_cfc12 .OR. ln_sf6
      !
      jptra       =  0
      jp_pisces   =  0    ;   jp_pcs0  =  0    ;   jp_pcs1  = 0
      jp_bling    =  0    ;!   jp_blg0  =  0    ;   jp_blg1  = 0
...
!          jp_blg1   = jp_bling
      ...
      IF(lwp) THEN                   ! control print
         ...
         WRITE(numout,*) '      Simulating BLING model                       ln_bling      = ', ln_bling
