...
Between versions 3.6 and 4.2.1 of NEMO there were substantial changes to the TOP module, which this new version of BLING accounts for.  Other modifications include a basic representation of nitrogen limitation, inspired by the MITgcm version of BLING (https://github.com/MITgcm/MITgcm/tree/master/pkg/bling).
